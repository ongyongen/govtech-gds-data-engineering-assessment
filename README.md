...
The output (preview of CSV files and the explanation for Q3) will be printed to the console as shown below <br></br>
...
Run `terraform destroy` to remove all resources previously configured <br></br>
